...
elseif strcmp(fun_name, 'sin') || strcmp(fun_name, 'cos') || strcmp(fun_name, 'asin') ...
        ...
        || strcmp(fun_name, 'tan') || strcmp(fun_name, 'sincos')
    res = 'trigo';
elseif  strcmp(fun_name, 'tanh') || strcmp(fun_name, 'sinh') || strcmp(fun_name, 'cosh') ...
        || strcmp(fun_name, 'asinh') || strcmp(fun_name, 'acosh') || strcmp(fun_name, 'atanh')
    res = 'trigoh';
