/*
 *   legacy_mydouble.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        int8 y1 = mydouble(int8 u1, int8 u2)
 *
 *   Simulink version           : 8.5 (R2015a) 09-Feb-2015
 *   C source code generated on : 25-Feb-2016 12:34:08
 ...
 */
#define S_FUNCTION_NAME                legacy_mydouble
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "mydouble", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  int8_T *u2 = (int8_T *) ssGetInputPortSignal(S, 1);
  int8_T *y1 = (int8_T *) ssGetOutputPortSignal(S, 0);
