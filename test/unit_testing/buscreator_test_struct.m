function buscreator_test_struct() 
% BUSCREATOR_TEST_STRUCT initializes a set of bus objects in the MATLAB base workspace 
...
BusUnif = Simulink.Bus;
BusUnif.HeaderFile = '';
BusUnif.Description = '';
BusUnif.DataScope = 'Auto';
BusUnif.Alignment = -1;
BusUnif.Elements = elems;
clear elems;
assignin('base','BusUnif', BusUnif);
