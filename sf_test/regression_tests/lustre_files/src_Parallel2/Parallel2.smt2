...
(rule (=> 
  (and (= top_n1__POINTTOP_N1_unless.__top_n1__POINTTOP_N1_unless_5 (= top_n1__POINTTOP_N1_unless.idTOP_N1_1 389))
       (= top_n1__POINTTOP_N1_unless.__top_n1__POINTTOP_N1_unless_4 (= top_n1__POINTTOP_N1_unless.idTOP_N1_1 388))
       (= top_n1__POINTTOP_N1_unless.__top_n1__POINTTOP_N1_unless_3 (and (= top_n1__POINTTOP_N1_unless.idTOP_N1_1 389) top_n1__POINTTOP_N1_unless.R1))
       (= top_n1__POINTTOP_N1_unless.__top_n1__POINTTOP_N1_unless_2 (and (= top_n1__POINTTOP_N1_unless.idTOP_N1_1 388) top_n1__POINTTOP_N1_unless.S1))
...
(rule (=> 
  (and (= top_n2__POINTTOP_N2_unless.__top_n2__POINTTOP_N2_unless_5 (= top_n2__POINTTOP_N2_unless.idTOP_N2_1 391))
       (= top_n2__POINTTOP_N2_unless.__top_n2__POINTTOP_N2_unless_4 (= top_n2__POINTTOP_N2_unless.idTOP_N2_1 390))
       (= top_n2__POINTTOP_N2_unless.__top_n2__POINTTOP_N2_unless_3 (and (= top_n2__POINTTOP_N2_unless.idTOP_N2_1 391) top_n2__POINTTOP_N2_unless.R2))
       (= top_n2__POINTTOP_N2_unless.__top_n2__POINTTOP_N2_unless_2 (and (= top_n2__POINTTOP_N2_unless.idTOP_N2_1 390) top_n2__POINTTOP_N2_unless.S2))
...
(rule (=> 
  (and (and (or (not (= (not TOP_N1_en.isInner) true))
       ...
       (= TOP_N1_en.__TOP_N1_en_3 (= TOP_N1_en.idTOP_N1_1 389))
       ...
       (= TOP_N1_en.__TOP_N1_en_2 (= TOP_N1_en.idTOP_N1_1 388))
...
(rule (=> 
  (and (and (or (not (= (not TOP_N2_en.isInner) true))
       ...
       (= TOP_N2_en.__TOP_N2_en_3 (= TOP_N2_en.idTOP_N2_1 391))
       ...
       (= TOP_N2_en.__TOP_N2_en_2 (= TOP_N2_en.idTOP_N2_1 390))
...
(rule (=> 
  (and (and (or (not (= (not Parallel2_TOP_en.isInner) true))
       ...
       (= Parallel2_TOP_en.idParallel2_Parallel2 392)
       )
...
(rule (=> 
  (and (= parallel2_parallel2__POINTParallel2_Parallel2_unless.__parallel2_parallel2__POINTParallel2_Parallel2_unless_2 (= parallel2_parallel2__POINTParallel2_Parallel2_unless.idParallel2_Parallel2_1 392))
...
(rule (=> 
  (and (= TOP_N1_ex.__TOP_N1_ex_1 (not TOP_N1_ex.isInner))
       ...
       (= TOP_N1_ex.__TOP_N1_ex_3 (= TOP_N1_ex.idTOP_N1_1 389))
       ...
       (= TOP_N1_ex.__TOP_N1_ex_2 (= TOP_N1_ex.idTOP_N1_1 388))
       ...
       (= TOP_N1_ex.idParallel2_TOP TOP_N1_ex.idParallel2_TOP_1)
       )
...
(rule (=> 
  (and (= TOP_N2_ex.__TOP_N2_ex_1 (not TOP_N2_ex.isInner))
       ...
       (= TOP_N2_ex.__TOP_N2_ex_3 (= TOP_N2_ex.idTOP_N2_1 391))
       ...
       (= TOP_N2_ex.__TOP_N2_ex_2 (= TOP_N2_ex.idTOP_N2_1 390))
       ...
       (= TOP_N2_ex.idParallel2_TOP TOP_N2_ex.idParallel2_TOP_1)
       )
...
(rule (=> 
  (and (TOP_N2_ex Parallel2_TOP_ex.idTOP_N2_1
       ...
       (= Parallel2_TOP_ex.idParallel2_Parallel2 Parallel2_TOP_ex.idParallel2_Parallel2_1)
       )
