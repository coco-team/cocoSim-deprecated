...
(rule (=> 
  (and (and (or (not (= (not T1_A_ex.isInner) true))
       ...
       (= T1_A_ex.idIek1_T1 T1_A_ex.idIek1_T1_1)
       )
...
(rule (=> 
  (and (and (or (not (= (not T1_B_ex.isInner) true))
       ...
       (= T1_B_ex.idIek1_T1 T1_B_ex.idIek1_T1_1)
       )
...
(rule (=> 
  (and (and (or (not (= (not T2_C_ex.isInner) true))
       ...
       (= T2_C_ex.idIek1_T2 T2_C_ex.idIek1_T2_1)
       )
...
(rule (=> 
  (and (and (or (not (= (not T2_D_ex.isInner) true))
       ...
       (= T2_D_ex.idIek1_T2 T2_D_ex.idIek1_T2_1)
       )
...
(rule (=> 
  (and (and (or (not (= (not T3_a_ex.isInner) true))
       ...
       (= T3_a_ex.idIek1_T3 T3_a_ex.idIek1_T3_1)
       )
...
(rule (=> 
  (and (and (or (not (= (not T3_b_ex.isInner) true))
       ...
       (= T3_b_ex.idIek1_T3 T3_b_ex.idIek1_T3_1)
       )
...
(rule (=> 
  (and (and (or (not (= (not T3_c_ex.isInner) true))
       ...
       (= T3_c_ex.idIek1_T3 T3_c_ex.idIek1_T3_1)
       )
...
(rule (=> 
  (and (and (or (not (= (not T3_d_ex.isInner) true))
       ...
       (= T3_d_ex.idIek1_T3 T3_d_ex.idIek1_T3_1)
       )
...
(rule (=> 
  (and (T2_D_ex Iek1_T2_ex.idIek1_T2_1
       ...
       (= Iek1_T2_ex.idIek1_Iek1 Iek1_T2_ex.idIek1_Iek1_1)
       )
...
(rule (=> 
  (and (T1_B_ex Iek1_T1_ex.idIek1_T1_1
       ...
       (= Iek1_T1_ex.idIek1_Iek1 Iek1_T1_ex.idIek1_Iek1_1)
       )
...
(rule (=> 
  (and (T3_b_ex Iek1_T3_ex.idIek1_T3_1
       ...
       (= Iek1_T3_ex.idIek1_Iek1 Iek1_T3_ex.idIek1_Iek1_1)
       )
